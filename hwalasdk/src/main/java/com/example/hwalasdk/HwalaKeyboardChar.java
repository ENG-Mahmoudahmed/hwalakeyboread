...
public class HwalaKeyboardChar extends LinearLayout implements View.OnClickListener {
...
//    private Button mButtonplus_number;
    ...
    private LinearLayout mButtonDelete,keychar,keynumber;
...
//        keyValues.put(R.id.button_plus_number, "+");
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.button_delete||v.getId() == R.id.button_delete_number) {
        ...
        else if(v.getId() == R.id.button_enter||v.getId() == R.id.button_enter_number) {
            setVisibility(View.GONE);
        }
        else if(v.getId() == R.id.button_change||v.getId() == R.id.button_change_char) {
